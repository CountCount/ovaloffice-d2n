...
if ( $u > 0 ) {
	if ( trim($_POST['fb']) != ''  ) {
 	  ...
 	  if ( $u != 83000 ) {
		...
		#mail("your@mail.com", "[D2N] Feedback (".$user[0]['name'].")", mysql_escape_string(nl2br(strip_tags($_POST['fb']))));
	}	
}
else {
	#mail("your@mail.com", "[D2N] Feedback error", "uid: ".$u."\n\n".mysql_escape_string(nl2br(strip_tags($_POST['fb']))));
}
