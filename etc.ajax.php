...
$events = array();
$events[1] = array(
	'title' => 'Clash of the Titans - test case',
	'logo' => '<img class="eventLogo" src="http://www.die2nite.com/file/33.dat" />',
	'towns' => array(
		18416, 18425, 18413, 18421, 18404, 18410
	),
	'desc' => 'This is the main comparison tool for the participating towns of the event "Clash of the Titans" which starts on <strong style="color:#00c;">January, 23<sup>nd</sup> 2012</strong>. The currently displayed towns are for developing purposes only.',
);
$events[2] = array(
	'title' => 'Season 4 - Fight for #1',
	'logo' => '<img class="eventLogo" src="http://www.die2nite.com/file/31.dat" />',
	'towns' => array(
		17866, 18017
	),
	'desc' => 'It\'s the Ring vs. the Forts!<br/>Can the forts get more points? Stay tuned and check daily for this challenge.',
);
$events[6] = array(
	'title' => 'Clash of the Titans',
	'logo' => '<img class="eventLogo" src="http://www.die2nite.com/file/33.dat" />',
	'towns' => array(
		19089, 19090, 19091, 19092, 19093, 19094
	),
	'desc' => 'Check out the participating towns of the event "Clash of the Titans" which started on <strong style="color:#00c;">January, 23<sup>nd</sup>/24<sup>th</sup> 2012</strong>.<br/>Who will be the real champions of the apocalypse?<br/><br/>News coverage of the Clash is done by the <a href="http://www.d2n-herald.com/" target="_new">D2N Herald</a>. Check it out!',
);
$events[7] = array(
	'title' => 'Battle of the Sexes',
	'logo' => '<img class="eventLogo" src="img/bots_button.png" />',
	'towns' => array(
		21114,21115
	),
	'desc' => 'Check out the ultimate fight between male and female zombie hunters!',
);
$events[11] = array(
	'title' => 'Clash of the Titans 2',
	'logo' => '<img class="eventLogo" src="img/cott2_button.png" />',
	'towns' => array(
		22475,22476,22477,22478,22479,22480,22482,22483
	),
	'desc' => 'Check out the participating towns of the second "Clash of the Titans" which started on <strong style="color:#00c;">June, 13<sup>th</sup> 2012</strong>.<br/>Who will be the new champions of the apocalypse?',
);
$events[14] = array(
  'title' => 'Die2Nite Apocalympics 2012',
  'logo' => '<img class="eventLogo" src="img/apocalympics.png" />',
  'towns' => array(
    23547,23548,23549,23550,23551,23552,23553
  ),
  'desc' => 'Check out the participating towns of the "Apocalympics".<br/>Who will win the "gold medal"?',
);
...
$signup[1] = array(
	...
	'desc' => 'This is the main comparison tool for the participating towns of the event "Clash of the Titans" which starts on <strong style="color:#00c;">January, 22<sup>nd</sup> 2012</strong>. This is <span style="color:#c00;">not a signup form</span> but an expression of interest. It can easily be turned into an official signup form if needed, though. Click here for test cases: <span onclick="eventSpy(1);" style="cursor:pointer;text-decoration:underline;color:#00c;">six towns in one table</span> or <span onclick="eventSpy(2);" style="cursor:pointer;text-decoration:underline;color:#00c;">the current fight for #1</span>.',
	'hide' => 0,
	'second' => 1,
);
$signup[3] = array(
	...
	'options' => array(
		...
		'Tamers' => '<img src="'.t('GAMESERVER_ICON').'r_jtamer.gif" />',
		'Technicians' => '<img src="'.t('GAMESERVER_ICON').'r_jtech.gif" />',
		'Any' => '<img src="'.t('GAMESERVER_ICON').'r_heroac.gif" />',
	),
	'desc' => 'This is the main comparison tool for the participating towns of the event "Clash of the Titans" which starts on <strong style="color:#00c;">January, 23<sup>nd</sup> 2012</strong> (Take note of the changed date!). This is now the <span style="color:#c00;">official signup form</span>!<br/>We are fully aware of the issues this first signup caused and we will heavily improve the registration process. Registration is now closed due to the control mechanisms currently taking place.<br/><br/>Click here for test cases how it will look like when the event starts: <span onclick="eventSpy(1);" style="cursor:pointer;text-decoration:underline;color:#00c;">six towns in one table</span> or <span onclick="eventSpy(2);" style="cursor:pointer;text-decoration:underline;color:#00c;">the close fight for #1</span>.',
	'hide' => 1,
	'second' => 0,
	'backup' => 1,
	'any' => 1,
...
$signup[6] = array(
	...
	'desc' => 'This is the main comparison tool for the participating towns of the event "Clash of the Titans" which starts on <strong style="color:#00c;">January, 23<sup>nd</sup> 2012</strong> (Take note of the changed date!). This is now the <span style="color:#c00;">final list of participants</span>!<br/><br/>Click here for test cases how it will look like when the event starts: <span onclick="eventSpy(1);" style="cursor:pointer;text-decoration:underline;color:#00c;">six towns in one table</span> or <span onclick="eventSpy(2);" style="cursor:pointer;text-decoration:underline;color:#00c;">the close fight for #1</span>.',
	'hide' => 0,
	'second' => 0,
	'backup' => 0,
	'any' => 0,
...
$signup[11] = array(
	...
	'logo' => '<img class="eventLogo" src="img/cott2_button.png" />',
	'options' => array(
		'Guardians I' => '<img src="'.t('GAMESERVER_ICON').'r_jguard.gif" />',
		'Scavengers I' => '<img src="'.t('GAMESERVER_ICON').'r_jcolle.gif" />',
		'Scouts I' => '<img src="'.t('GAMESERVER_ICON').'r_jrangr.gif" />',
		'Survivalist I' => '<img src="'.t('GAMESERVER_ICON').'r_jermit.gif" />',
		'Survivalist II' => '<img src="'.t('GAMESERVER_ICON').'r_jermit.gif" />',
		'Survivalist III' => '<img src="'.t('GAMESERVER_ICON').'r_jermit.gif" />',
		'Tamers I' => '<img src="'.t('GAMESERVER_ICON').'r_jtamer.gif" />',
		'Tamers II' => '<img src="'.t('GAMESERVER_ICON').'r_jtamer.gif" />',
		'Techs I' => '<img src="'.t('GAMESERVER_ICON').'r_jtech.gif" />',
		'Techs II' => '<img src="'.t('GAMESERVER_ICON').'r_jtech.gif" />',
    #'Shamans I' => '<img src="'.t('GAMESERVER_ICON').'item_shaman.gif" />',
    #'Guardians II' => '<img src="'.t('GAMESERVER_ICON').'r_jguard.gif" />',
    #'Scavengers II' => '<img src="'.t('GAMESERVER_ICON').'r_jcolle.gif" />',
    #'Scouts II' => '<img src="'.t('GAMESERVER_ICON').'r_jrangr.gif" />',
    #'Survivalist II' => '<img src="'.t('GAMESERVER_ICON').'r_jermit.gif" />',
    #'Tamers II' => '<img src="'.t('GAMESERVER_ICON').'r_jtamer.gif" />',
    #'Techs II' => '<img src="'.t('GAMESERVER_ICON').'r_jtech.gif" />',
    #'Shamans II' => '<img src="'.t('GAMESERVER_ICON').'item_shaman.gif" />'
	),
	'desc' => 'This is the registration for the event "Clash of the Titans 2". Registration opens on <strong style="color:#00c;">May 29, 2012 at 11:22:33pm (game time)</strong>. (If counter hits zero seconds, just click the badge to the right again to enable registration.)<br>Note: Shaman town has been ditched due to low number of registrations on request by Epoq (30 May, 2pm). The shaman option was never intended to be there at all, misunderstanding on my side.<br><br><em>If new towns pop up, don\'t switch from like Tamer I to Tamer II. If the second town doesn\'t fill up, it\'s likely to not take part at all. So you might loose your place by switching (too early).</em>',
	'hide' => 0,
	'second' => 0,
	'backup' => 1,
	'any' => 0,
...
$signup[14] = array(
  ...
  'logo' => '<img class="eventLogo" src="img/apocalympics.png" />',
  'options' => array(
    'Residents' => '<img src="'.t('GAMESERVER_ITEM').'basic_suit.gif" />',
  ),
  'desc' => 'This will be the registration for the "Apocalympics 2012". Registration opens on June 24th after attack. Number of towns will be defined by your interest, 240 participants will result in six towns whereas 400 participants will result in 10 towns. Well, you do the math.',
  'hide' => 0,
  'second' => 0,
  'backup' => 0,
  'any' => 0,
...
if ( $e < 0 ) {
  ...
  if ( isset($signup[$s]['start']) ) {
    ...
    if ( ((isset($signup[$s]['start']) && $signup[$s]['start'] <= time()) || !isset($signup[$s]['start'])) && ((isset($signup[$s]['end']) && $signup[$s]['end'] >= time()) || !isset($signup[$s]['end'])) ) {
    ...
    elseif (isset($signup[$s]['end']) && $signup[$s]['end'] <= time()) {
      print '<button disabled="disabled">'.t('REGISTRATION_CLOSED').'</button>';
    }
    else {
	...
	print '</tr>';
	$z = 0;
	print '<tr><th>Participants<br/><button class="signup" onclick="eventSignup('.$s.',\''.$k.'\',\'none\');">'.t('PRIMARY_BAILOUT').'</button></th>';
	foreach ( $options AS $option => $icon ) {
		$z++;
		$r = $signups[$option];
		if ( !is_array($r[0]) ) {
	...
	if (in_array($username,array('SinSniper','Workshop','Epoq'))) {
	...
	if ( $signup[$s]['backup'] == 1 ) {
		print '<tr><th>Backup<br/><button class="signup" style="display:block;padding:3px;width:80px;margin:0 auto;" onclick="eventSignup('.($s + 2).',\''.$k.'\',\'none\', 2);">'.t('BACKUP_BAILOUT').'</button></th>';
		foreach ( $options AS $option => $icon ) {
			$z++;
			$r = $signups3[$option];
			if ( !is_array($r[0]) ) {
